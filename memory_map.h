...
#define DSM_RANGE_ADDR                      (TEMPORARY_DATA_BUFFER_MAP_ADDR + sizeof(TEMPORARY_DATA_BUF_MAP))
#define TRIM_VALID_BIT_MAP_ADDR				(DSM_RANGE_ADDR + sizeof(DSM_RANGE))

// for map tables
#define LOGICAL_SLICE_MAP_ADDR				(TRIM_VALID_BIT_MAP_ADDR + sizeof(TRIM_VALID_BIT_MAP))
